...
const theatreSchema = new mongoose.Schema({
     ...
     * type: mongoose.Schema.Types.ObjectId now abb yha id store hogi field mai lekin sirf ek collection mai ek id store hogi...
     * type: [mongoose.Schema.Types.ObjectId] but iss trh se multiple id's store hogi ek field mai...
    */
    movies: {
